...
export function buildGenerationPrompt({ request, callbackUrl }) {
    ...
    return [
        ...
        "   If the sample supports a meaningful goal/status assessment, add artifactReview: {phase: <sample.phase>, sampleFingerprint: <sample.fingerprint>, goal: <concise goal supported by the document>, statuses: [{id, label, criterion}]}. Define 2-6 distinct reusable statuses. IDs are unique lowercase identifiers up to 40 characters; labels are unique 1-3 word phrases up to 60 characters; goal and each criterion are at most 1000 characters. All text is nonempty, trimmed and single-line. These exact labels apply to EVERY workflow in this generated app.",
